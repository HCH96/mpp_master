...
public class firstPage extends Fragment implements DatePickerDialog.OnDateSetListener{
                    ...
                    for (DataSnapshot childData : currData.getChildren()) {
                        ...
                        cb.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                // 할 일 DB 위치 이동을 위해 기존 DB 내용을 받아와
                                // 위치와 timeline 정보를 업데이트해서 setValue로 새 위치에 넣어줌
    ...
    // firstPage에 처음 접속 시 화면에 할 일이 표시되지 않는 기능을 보완하기 위해 함수를 생성함
    // 코드 내용은 위와 같음
    public void setting(){
