...
public class Stats extends AppCompatActivity {
    ...
    int category4_sumTime = 0;
    int category5_sumTime = 0;
    int category6_sumTime = 0;
    int category7_sumTime = 0;
                                ...
                                new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot2) {
                                        ...
                                        */
                                            ...
                                            if(category4_sumTime != 0) yValues.add(new PieEntry(category4_sumTime, "수업"));
                                            if(category5_sumTime != 0) yValues.add(new PieEntry(category5_sumTime, "시험"));
                                            if(category6_sumTime != 0) yValues.add(new PieEntry(category6_sumTime, "약속"));
                                            if(category7_sumTime != 0) yValues.add(new PieEntry(category7_sumTime, "알바"));
                                            // 데이터 추가 후 새로고침
                                            ...
                                            colors.add(Color.parseColor("#607d8c"));
                                            colors.add(Color.parseColor("#607d8d"));
                                            colors.add(Color.parseColor("#607d8e"));
                                            colors.add(Color.parseColor("#607d8f"));
                                            colors.add(Color.parseColor("#607d8c"));
